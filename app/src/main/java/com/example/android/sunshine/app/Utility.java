...
public class Utility {
    ...
    public static boolean isMetric(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        return prefs.getString(context.getString(R.string.temperature_pref_key),
                context.getString(R.string.temperature_pref_metric))
                .equals(context.getString(R.string.temperature_pref_metric));
    }
    ...
    static public @SunshineSyncAdapter.LocationStatus int getLocationStatus(Context c) {
        ...
        return pf.getInt(c.getString(R.string.pref_location_status_key), SunshineSyncAdapter.LOCATION_STATUS_UNKNOWN);
    ...
    static public  void resetLocationStatus(Context c) {
        SharedPreferences pf = PreferenceManager.getDefaultSharedPreferences(c);
        pf.edit().putInt(c.getString(R.string.pref_location_status_key), SunshineSyncAdapter.LOCATION_STATUS_UNKNOWN).apply();
    ...
    /*
    * Helper method to provide the correct image url according to the weather condition id returned
    * by the OpenWeatherMap call.
    *
    * @param weatherId from OpenWeatherMap API response
